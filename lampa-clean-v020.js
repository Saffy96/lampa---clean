...
(function () {
  ...
  if (window.__LAMPA_CLEAN_V020__) return;
  window.__LAMPA_CLEAN_V020__ = true;
  ...
  function preparePlayerData(event) {
    ...
    // Lampa skips its preroll when player_data.iptv is true.
    // We set it only for the preroll decision and restore it as soon as
    // playback/external launch starts.
  ...
  // Backup cleanup for already-created ad UI.
